...
<head>
    ...
    <title>Derechos - Punto Violeta</title>
</head>
...
<body>
    ...
    <section class="container-fluid min-height">
        ...
        <!-- TOP NAV -->
        <nav class="nav">
            <svg class="menu-ham" width="26" height="23" viewBox="0 0 26 23" fill="currentcolor"
                xmlns="http://www.w3.org/2000/svg" onclick="mostrarMenu()">
